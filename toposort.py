...
def toposort(data):
    ...
    cyclic_dependencies = data if data else None
    return ordered_sets, cyclic_dependencies


def toposort_flatten(data, sort=True):
    """Returns a single list of dependencies.

    For any set returned by toposort(), those items are sorted and
    appended to the result (just to make the results deterministic)."""
